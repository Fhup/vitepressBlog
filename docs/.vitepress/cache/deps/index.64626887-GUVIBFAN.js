import {
  A,
  R
} from "./chunk-ZKAJHNWV.js";
import "./chunk-NAHOXKNU.js";
import {
  __require
...
var Ul = class {
  ...
  clone(e) {
    const t = new Ul(), r = Object.keys(this);
...
var Ft = class extends Oa {
  ...
  normalize(e, t) {
    ...
    return e.map((i) => (i[am] || Ft.rebuild(i), i = i.proxyOf, i.parent && i.parent.removeChild(i), i[nm] && um(i), typeof i.raws.before > "u" && t && typeof t.raws.before < "u" && (i.raws.before = t.raws.before.replace(/\S/g, "")), i.parent = this, i));
  }
  getProxyProcessor() {
    return {
      set(e, t, r) {
...
var dr = class {
  constructor(e, t, r) {
    ...
    if (typeof t == "object" && t !== null && (t.type === "root" || t.type === "document"))
      i = ul(t);
    else if (t instanceof dr || t instanceof Vn)
...
async function Lh() {
  return await import("./index.76c75465-JFJVCR5H.js").then((s3) => s3.i).then((s3) => s3.default);
}
async function Mh() {
  return await import("./babel.dc741a6c-I7EZCZXH.js").then((s3) => s3.b).then((s3) => s3.default ? s3.default.transform : s3.transform);
}
async function Ox() {
  return await import("./dist-6HIGZZN7.js").then((s3) => s3.default);
}
export {
  Dx as default
};
...
*/
//# sourceMappingURL=index.64626887-GUVIBFAN.js.map
